               ...
               <div className='flex'>
                  <div className='w-1/6'>
                     <div className='pb-[12px]'>
                        <div className=''>
                           <h4 className='mb-[10px] text-[14px] font-[600] uppercase leading-[22px]'>Về GEARVN </h4>
                        </div>
                        <div>
                  ...
                  <div className='w-1/6'>
                     <div className='pb-[12px]'>
                        <div className=''>
                           <h4 className='mb-[10px] text-[14px] font-[600] uppercase leading-[22px]'>Chính sách </h4>
                        </div>
                        <div>
                           <ul className='mb-[10px] text-[14px]'>
                              <li className='pb-[8px] hover:cursor-pointer hover:text-red-500 hover:underline'>
                  ...
                  <div className='w-1/6'>
                     <div className='pb-[12px]'>
                        <div className=''>
                           <h4 className='mb-[10px] text-[14px] font-[600] uppercase leading-[22px]'>Thông tin </h4>
                        </div>
                        <div>
                           <ul className='mb-[10px] text-[14px]'>
                              <li className='pb-[8px] hover:cursor-pointer hover:text-red-500 hover:underline'>
